...
The `DLV-UX-002` story breakdown and scope boundaries are defined in the
consolidated `EP-UX-001_user_stories.md` story document. Its M0 evidence is limited to
