...
export function WorkflowExample() {
  ...
  return <div className="space-y-6">
    ...
    <div className="grid min-w-0 items-start gap-6 xl:grid-cols-2"><ApprovalPanel approval={approvalFixture} /><PostingPanel posting={postingFixture} onRetry={() => setOutcome('Retry requires deliberate user action after request lookup; no automatic retry was performed.')} /></div>
