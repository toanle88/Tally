...
describe('App', () => {
  it('renders the TALLY shell regions and synthetic foundation preview', () => {
    ...
    expect(screen.getByText(/Authentication, authorization, database readiness/)).toBeInTheDocument()
    expect(container.querySelector('[data-theme="finance-light"]')).toBeInTheDocument()
    expect(container.querySelector('[data-theme="finance-dark"]')).toBeInTheDocument()
  })
})
