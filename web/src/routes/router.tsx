...
function routeElement(route: RouteDefinition) {
  const content = route.id === 'iamWorklist' || route.id === 'iamEmergencyAccess' ? <IdentityAccessWorkspace /> : route.kind === 'operational' ? <OperationalPage route={route} /> : route.kind === 'development' ? <DevelopmentExamples /> : <AreaPage route={route} />
