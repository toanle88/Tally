...
run "accepts_learning_liveness_probe" {
  command = plan
  ...
  variables {
    ...
    secret_refs   = []
    tags          = { application = "tally", environment = "dev", owner = "team", cost_center = "learning", managed_by = "terraform", data_classification = "synthetic" }
  }
}
